...
\begin{center}
{\huge \bfseries Imad EL BADISY}\\[3pt]
{\large Computational Methodologist}\\[4pt]
...
Computational methodologist, PhD, building software for machine learning and computational biostatistics. My methodological research centers on scientific machine learning, survival analysis, missing data imputation, and agentic data science. I hold a PhD in Biomedical Sciences from Aix-Marseille University (SESSTIM laboratory) on missing data and machine learning methods for survival analysis. I turn advanced statistical and machine learning methods into reliable, open-source R packages, including tools for survival machine learning, neural survival models, and imputation, and I contribute as a consultant and trainer in biostatistics and machine learning.
...
**Methods:** Scientific machine learning · Survival analysis · Missing data imputation · Agentic data science · Computational biostatistics · Biostatistics and epidemiology · Meta-analysis and evidence synthesis · Interpretable machine learning · Deep learning · Monte Carlo simulation
...
\cvrow{{\bf Mohammed VI Center for Research and Innovation (CM6RI)}}{Rabat, Morocco}
\vspace{-0.17cm}
\cvrow{\textit{Research Engineer in Health Data Science}}{Nov. 2021 – Jan. 2026}
\vspace{-0.16cm}
...
\textit{Outside working hours:} Organizer of Methods in Health Data Science with R (MHDSR), an independent training pathway (BIOSTATR, ML4HOR) covering applied biostatistics, survival analysis, and machine learning with R
